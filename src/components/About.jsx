...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-lg text-blue-700 font-medium mb-2">{dynamicRole}</h2>
      ...
      <div className="flex gap-4 mb-4">
        <a
          ...
          aria-label="LinkedIn"
          className="hover:text-blue-700 text-2xl flex items-center"
        >
        ...
        <a
          ...
          rel="noopener noreferrer"
          aria-label="GitHub"
          className="hover:text-gray-800 text-2xl flex items-center"
        >
